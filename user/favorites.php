...
try {
    ...
    $countQuery = "SELECT COUNT(*) AS totalDocs FROM favorites WHERE user_id = :user_id";
    ...
    if ($totalDocs === 0) {
        ...
        echo json_encode(["error" => "Nenhuma palavra favoritada encontrada."]);
        exit;
    }

    $query = "SELECT word, added FROM favorites WHERE user_id = :user_id ORDER BY added DESC LIMIT :limit OFFSET :offset";
